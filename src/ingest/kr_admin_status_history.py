...
이 이력은 backtest(data_access._admin_halt_status_at, auditor.post_audit)에 연결돼 있다 —
asof 시점 관리종목/매매거래정지 판정에 실제로 쓰인다. 자연어 SQL 질의 대상은 아니다
(QUERYABLE_TABLES 미포함, src/db.py 참고).
"""
